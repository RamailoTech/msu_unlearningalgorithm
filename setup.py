...
#             "git+https://github.com/Phoveran/fastargs.git@main#egg=fastargs",
...
setup(
    ...
    install_requires=[
        ...
        "fastargs @ git+https://github.com/Phoveran/fastargs.git@main#egg=fastargs",
        "T2IBenchmark @ git+https://github.com/boomb0om/text2image-benchmark",
    ] + load_requirements(),
    extras_require={},
    entry_points={
        "console_scripts": [
