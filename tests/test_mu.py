...
def test_generate_safe_tensors(setup_output_dir_forget_me_not_ti):
    """
...
def test_run_mu_forget_me_not(setup_output_dir_forget_me_not_finetuned, setup_output_dir_forget_me_not_ti):
    """
