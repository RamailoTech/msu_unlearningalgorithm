...
def main():
    ...
    # Training parameters
    parser.add_argument('--train_method', type=str,  choices=['full', 'partial'], help='Training method')
    ...
    parser.add_argument('--guided_concepts', type=str,  help='Concepts to guide the editing')
    parser.add_argument('--technique', type=str,  choices=['replace', 'tensor'], help='Editing technique')
