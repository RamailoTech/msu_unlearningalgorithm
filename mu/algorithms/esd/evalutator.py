...
class ESDSampler(BaseSampler):
    ...
    def __init__(self, config: dict, **kwargs):
        """
        Initialize the ESDImageGenerator with a YAML config (or dict).
    ...
    def load_model(self) -> None:
        ...
        This example shows a direct load of a single model + DDIMSampler.
        In practice, if you have an ESDModel with two models, adapt accordingly.
        """
