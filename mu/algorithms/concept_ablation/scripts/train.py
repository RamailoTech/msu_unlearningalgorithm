...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="Alpha parameter if needed for training.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a delta checkpoint, if any.",
    )
    ...
    parser.add_argument(
        "--output_dir", type=str, required=True, help="Directory to store results."
    )
    parser.add_argument(
        "--train_size",
        type=int,
        default=1000,
        help="Number of generated training images.",
    )
    parser.add_argument(
        "--n_samples",
        type=int,
        default=10,
        help="Number of images per prompt batch generation step.",
    )
    ...
    # DataLoader configs
    parser.add_argument(
        "--batch_size", type=int, default=4, help="Batch size for training DataLoader."
    )
    parser.add_argument(
        "--num_workers",
        type=int,
    ...
    parser.add_argument(
        "--pin_memory", type=bool, default=True, help="Use pinned memory in DataLoader."
    )
    ...
    parser.add_argument(
        "--use_regularization",
        action="store_true",
        help="Use a regularization dataset if applicable.",
    )
    ...
    parser.add_argument(
        "--project_name",
        type=str,
        default="concept_ablation_project",
        help="WandB project name.",
    )
    parser.add_argument(
        "--run_name", type=str, default="concept_ablation_run", help="WandB run name."
    )
    parser.add_argument(
        "--output_name",
        type=str,
        default="concept_ablation_model.pth",
