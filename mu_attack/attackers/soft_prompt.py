...
class SoftPromptAttack:
    ...
    def __init__(self, model, model_orig, tokenizer, text_encoder, sampler,
                 ...
                 image_size, criteria, k, all_embeddings):
        self.model = model
    ...
    def attack(self, global_step, word, attack_round, attack_type,
        ...
        for i in range(attack_step):
            ...
            with torch.no_grad():
                # Generate an image with the concept from the frozen model.
            ...
            # Get the conditional score from the ESD model with the adversarial condition embedding.
